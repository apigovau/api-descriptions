...
<p class="intro__button"><a class="au-btn au-btn--secondary" target="_blank href="https://api.gov.au/swagger-ui/index.html?url=https://api.gov.au/github?path%3dabs~DataAPI.openapi.yaml">Try it out</a></p>
</div>
