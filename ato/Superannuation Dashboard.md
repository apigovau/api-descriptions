...
[![Generated class diagram from swagger](https://api.gov.au/graph/swagger.svg?url=https://api.gov.au/swagger/superannuation-dashboard.yaml)](https://api.gov.au/graph/swagger.svg?url=https://api.gov.au/swagger/superannuation-dashboard.yaml)
